...
void CopyArrayWithAddArrayElement(int arrSource[100], int arrDestination[100], int arrLength,int &arr2Length) {
...
int main()
{
    ...
    CopyArrayWithAddArrayElement(arr1, arr2,arrLength, arr2Length);
