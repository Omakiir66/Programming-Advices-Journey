...
void CopyPrimeElementsInArray(int arrSource[100], int arrDestination[100], int arrLength, int &arr2Length) {
    int Counter = 0;
    for (int i = 0;i < arrLength;i++) 
    {
...
int main()
{
    ...
    CopyPrimeElementsInArray(arr1, arr2, arrLength, arr2Length);
